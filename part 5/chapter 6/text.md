...
Исходники примера находятся [здесь](src1.cpp).
...
Модифицированный исходный код находится [здесь](src2.cpp). Также предлагаю к скачиванию текстуры деревянной игрушки: [диффузная](wood.png), [карта нормалей](toy_box_normal.png), [карта глубин](toy_box_disp.png).
...
Код примера находится [здесь](src3.cpp).
...
Сравнение всех методов в одном [коллаже](qnx9ac0vksqns664zkifo5lf68a.jpeg), объем 3Мб.
