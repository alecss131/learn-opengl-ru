...
Исходный код можно найти [тут](src1.cpp).
...
Если у вас возникли какие-либо проблемы, пробегитесь по уроку, возможно вы что-то забыли. Также вы можете сверится с [исходным кодом](src2.cpp).
...
1. Попробуйте отрисовать 2 треугольника один за другим с помощью glDrawArrays с помощью добавления бОльшего количества вершин. [Решение](exercise1.cpp)
2. Создайте 2 треугольника с использованием 2 различных VAO и VBO. [Решение](exercise2.cpp)
3. Создайте второй фрагментный шейдеры и чтобы он выводил желтый цвет. И сделайте так, чтобы второй треугольник был желтого цвета. [Решение](exercise3.cpp)
