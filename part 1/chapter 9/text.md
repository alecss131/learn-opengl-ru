...
Не стесняйтесь экспериментировать, и если что-то не работает, сравните свой код с [исходным кодом](https://github.com/loginmen/learnopengl/blob/master/part%201/chapter%209/src5.cpp).
