...
Вы можете найти полный код [здесь](src1.cpp).
...
Воссоздайте различные типы атмосферных сцен, с последнего изображения, заменив значения артрибутов света [ссылка](exercise1.cpp).
